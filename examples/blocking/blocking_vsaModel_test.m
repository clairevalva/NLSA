function [ model, In, Out ] = blocking_vsaModel_test(experiment, givephi, nbatch)
...
In.idxPhiRec  = givephi;    % eigenfunctions for reconstruction
...
In.idxKoopmanRec  = {[5], [6], }; % done [ 4:12]
