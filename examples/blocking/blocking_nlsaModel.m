...
case 'z500_20101230-20111031_emb20_coneKernel'
    ...
    % Batches to partition the in-sample data
    In.Res( 1 ).nB    = 4; % partition batches, make higher for less RAM
    In.Res( 1 ).nBRec = 1; % batches for reconstructed data
...
case 'z500_20101230-20181031_emb20_coneKernel'
    % { '20100101' '20181031' }
    % Dataset specification  
    In.Res( 1 ).experiment = 'blocking';                
    ...
    % Time specification
    In.tFormat        = 'yyyymmdd';              % time format
    In.Res( 1 ).tLim  = { '20101230' '20181031' }; % time limit  
    ...
    % Batches to partition the in-sample data
    In.Res( 1 ).nB    = 5; % partition batches, make higher for less RAM
    In.Res( 1 ).nBRec = 1; % batches for reconstructed data
